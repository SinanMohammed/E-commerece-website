<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql = "select * from store where id='$username' and password='$password'";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="p-3 mb-2 bg-info text-dark">
            <div class="container">
                <h2 class="text-center"><b><i>Store LogIn</i></b></h2>
                ...
                <div class="col-sm-5">
                   ...
                   <h5 class="text-center">Not a Member? <a href="signup.php"><b>SignUp</b></a></h5><br>
                </div>
                </div>
